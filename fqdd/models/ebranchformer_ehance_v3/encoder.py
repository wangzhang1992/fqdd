...
from fqdd.modules.feature_fusion import AdaptiveFeatureFusion
from fqdd.nnets.base_utils import FQDD_NORMALIZES, FQDD_ACTIVATIONS
from fqdd.models.ebranchformer_ehance_v3.encoder_layer import ConvolutionalGatingMLP, EBranchformerEncoderLayer
        ...
        self.encoders = LayerDropModuleList(
            ...
            modules=[
                EBranchformerEncoderLayer(
                    ...
                    AdaptiveFeatureFusion(output_size, output_size, output_size, activation_type, dropout_rate),
