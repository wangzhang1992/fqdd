...
from fqdd.models.ebranchformer_ehance_v2.encoder import EBranchformerEncoder
from fqdd.models.ebranchformer_ehance_v2.decoder import TransformerDecoder
...
class EBranchformer_Ehance_V2(nn.Module):
    def __init__(
            self,
            model_conf,
    ):
        super(EBranchformer_Ehance_V2, self).__init__()
