            ...
            for t in range(inputs_list[batch]):
                ...
                for y in BHat:
                    ...
                    if len(y) > 0:
                        ...
                        prNonBlank = last.entries[y].prNonBlank * mat[
                            t, y[-1]]  # 相同的y两种可能，加入重复或者加入空白,如果之前没有字符，在NonBlank概率为0
...
if __name__ == '__main__':
    classes = ["a", "b"]
    mat = np.array([[[0.4, 0, 0.6], [0.4, 0, 0.6], [0, 1, 0], [0, 0, 0]],
                    [[0.4, 0, 0.6], [0.4, 0, 0.6], [0.4, 0.1, 0.5], [0.2, 0.5, 0.3]]])
