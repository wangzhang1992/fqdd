...
if [ $stop_stage -ge 0 ] && [ $start_stage -le 0 ]; then
    python fqdd/bin/asr/train.py
fi

if [ $stop_stage -ge 1 ] && [ $start_stage -le 1 ]; then
    python fqdd/bin/asr/train.py
fi

if [ $stop_stage -ge 2 ] && [ $start_stage -le 2 ]; then
    python fqdd/bin/asr/train.py
fi

if [ $stop_stage -ge 3 ] && [ $start_stage -le 3 ]; then
    python fqdd/bin/asr/train.py
fi
